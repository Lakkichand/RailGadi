...
public class TrackYourTrainFragment extends Fragment implements IPnrDeleteCommunicator, ILiveTrainInterface, ICloseEverything, IAutoSuggestion, IStationsViaTrainNumber {
    ...
    private TextView trackTrainButon, today, yesterday, tomorrow;
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        MainActivity.toolbar.setTitle(getActivity().getResources().getString(R.string.track_your_train).toUpperCase());

        MainActivity.closeFragmentObject = TrackYourTrainFragment.this;
    ...
    private void initializeAllViews() {
        ...
        autoSearchLayout.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                autoSuggestionTask = new AutoSuggestionTask(getActivity(), searchTerm, TrackYourTrainFragment.this);
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                if (trainNumber  != null && trainNumber.length() == 5) {
                    ...
                    if (InternetChecking.isNetWorkOn(getActivity())) {
                        ...
                        miniTimeTableTask = new MiniTimeTableTask(getActivity(), trainNumber, TrackYourTrainFragment.this);
        ...
        enterTrainNumberEditText.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                String selectedTrain = autoAdapter.getItem(position).toString();
                trainNumber = selectedTrain.substring(0, 5);
        ...
        enterTrainNumberEditText.addTextChangedListener(new TextWatcher() {
            ...
            public void onTextChanged(CharSequence s, int start, int before, int count) {
                ...
                autoSuggestionTask = new AutoSuggestionTask(getActivity(), s.toString(), TrackYourTrainFragment.this);
                autoSuggestionTask.execute();
            }
        ...
        trackTrainButon = (TextView) rootView.findViewById(R.id.show_live_train_status_button);
        trackTrainButon.setText("Track Now");
        ...
        recentSearchListView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
            ...
            public boolean onItemLongClick(AdapterView<?> parent, View view, int position, long id) {
                ...
                UtilsMethods.confirmDeleteDialog(getActivity(), TrackYourTrainFragment.this);
                return true ;
            }
        });
    ...
    private void setDataOnViews() {
        ...
        trackTrainButon.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                ...
                if (InternetChecking.isNetWorkOn(getActivity())) {
                    ...
                    if (trainNumber != null && trainNumber.length() == 5) {
                        liveTrainNewTask = new LiveTrainNewTask(getActivity(), trainNumber, selectedStationCode, selectedDate, miniTimeTableBean, TrackYourTrainFragment.this);
    ...
    private void closeStationLayout() {
        ...
        MainActivity.toolbar.setTitle(getActivity().getResources().getString(R.string.track_your_train));
    ...
    public void updateLiveTrainData(LiveTrainNewBean liveTrainNewBean, TimeTableNewBean ttb) {
        ...
        if(liveTrainNewBean.getLastStation() == null) {
            ...
            LiveTrainTrackingPreferences liveTrackPreferences = new LiveTrainTrackingPreferences(getActivity()) ;
            ...
            Toast.makeText(getActivity(), "Train tracked and added to Home", Toast.LENGTH_SHORT).show() ;
        }
    }
