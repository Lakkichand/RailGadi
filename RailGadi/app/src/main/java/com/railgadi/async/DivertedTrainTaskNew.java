...
public class DivertedTrainTaskNew extends AsyncTask<Void, Void, Void> {
    ...
    public DivertedTrainTaskNew(Context context, ResDivCanFragmentNew fragment) {
    ...
    protected void onPreExecute() {
        ...
        pro = UtilsMethods.getStandardProgressDialog(context, DivertedTrainTaskNew.this);
        pro.show();
    }
    ...
    protected Void doInBackground(Void... params) {
        ...
        String response     =   HttpServicesRailGadi.POST(ApiConstants.DIVERTED_TRAINS, CommonInputJsonMethod.getInputApiKeyOnly(context)) ;
        ...
        try {
            ...
            if (jsonObject.has("code") && jsonObject.has("message")) {
                ...
                bean = JsonResponseParsing.getDivertedTrains(jsonObject);
            }
            if (bean == null) {
                error = "No Data Found";
            }
