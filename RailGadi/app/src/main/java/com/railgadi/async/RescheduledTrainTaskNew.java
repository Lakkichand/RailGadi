...
public class RescheduledTrainTaskNew extends AsyncTask<Void, Void, Void> {
    ...
    public RescheduledTrainTaskNew(Context context, ResDivCanFragmentNew fragment) {
    ...
    protected void onPreExecute() {
        ...
        pro = UtilsMethods.getStandardProgressDialog(context, RescheduledTrainTaskNew.this);
        pro.show();
    }
    ...
    protected Void doInBackground(Void... params) {
        ...
        String response     =   HttpServicesRailGadi.POST(ApiConstants.RESCHEDULED_TRAINS, CommonInputJsonMethod.getInputApiKeyOnly(context)) ;
        ...
        try {
            ...
            if (jsonObject.has("code") && jsonObject.has("message")) {
                ...
                bean = JsonResponseParsing.getRescheduledTrains(jsonObject);
            }
            if (bean == null) {
                error = "No Data Found";
            }
