...
import com.railgadi.beans.FareEnquiryNewBean.FareDetails;
import com.railgadi.fonts.AppFonts;

import java.util.List;

public class FareBreakUpListNewAdapter extends BaseAdapter {
    ...
    public FareBreakUpListNewAdapter(Context context, List<FareDetails> fareList) {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        FareDetails entry = fareList.get(position) ;
