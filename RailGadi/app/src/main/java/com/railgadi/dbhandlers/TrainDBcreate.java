...
public class TrainDBcreate extends SQLiteOpenHelper {
    ...
    public TrainDBcreate(Context context) {

        super(context, TRAIN_DB_NAME, null, 1);
    ...
    private boolean checkDataBase() throws Exception {
        ...
        String myPath = DB_PATH + TRAIN_DB_NAME ;
        try {
    ...
    private void copyDataBase() throws IOException {
        ...
        InputStream myInput = myContext.getResources().getAssets().open(TRAIN_DB_NAME);

        // Path to the just created empty db
        String outFileName = DB_PATH + TRAIN_DB_NAME;
