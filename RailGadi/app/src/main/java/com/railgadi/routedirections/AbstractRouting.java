package com.railgadi.routedirections;
 ...
 * Requires an instance of the map mainActivity and the application's current context for the progress dialog.
 *
 */
...
public abstract class AbstractRouting<T> extends AsyncTask<T, Void, Route> {
    ...
    public AbstractRouting(TravelMode mTravelMode) {
        this._aListeners = new ArrayList<>();
