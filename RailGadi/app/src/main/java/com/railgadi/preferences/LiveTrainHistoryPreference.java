...
public class LiveTrainHistoryPreference {
    ...
    public LiveTrainHistoryPreference(Activity activity) {

        this.activity = activity;
        preferences = this.activity.getPreferences(activity.MODE_PRIVATE);

        this.KEY = this.activity.getResources().getString(R.string.live_train_recent_preference) ;
    }
