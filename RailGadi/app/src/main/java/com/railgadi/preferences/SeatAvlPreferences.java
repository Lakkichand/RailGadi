...
public class SeatAvlPreferences {
    ...
    public SeatAvlPreferences(Activity activity) {

        this.activity = activity;
        preferences = this.activity.getPreferences(activity.MODE_PRIVATE);

        this.KEY = this.activity.getResources().getString(R.string.seat_avl_history_pref_key);
    }
